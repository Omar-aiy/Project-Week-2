...
public class OmhullendeTest {
    ...
    @Test
    public void getMinimumX_moet_correcte_waarde_teruggeven(){
        Omhullende a = new Omhullende((new Punt(5,10)),10,5);
        assertEquals(5,a.getMinimumX());
    }
    @Test
    public void getMinimumY_moet_correcte_waarde_teruggeven(){
        Omhullende a = new Omhullende((new Punt(5,10)),10,5);
        assertEquals(10,a.getMinimumY());
    }
    @Test
    public void getMaximumX_moet_correcte_waarde_teruggeven(){
        Omhullende a = new Omhullende((new Punt(5,10)),10,5);
        assertEquals(15,a.getMaximumX());
    }
    @Test
    public void getMaximumY_moet_correcte_waarde_teruggeven(){
        Omhullende a = new Omhullende((new Punt(5,10)),10,5);
        assertEquals(15,a.getMaximumY());
    }
}